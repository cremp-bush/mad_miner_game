            ...
            if(buttonList.count != 0)
            {
                ...
                while(p != NULL)
                {
                        ...
                        (event.button.y >= p->object_info->rect.y && event.button.y <= p->object_info->rect.y + p->object_info->rect.h))
                    {
                        ...
                        // if(select->object_info->text_info->allign == "left");
                        // else if(select->object_info->text_info->allign == "center") select->object_info->rect.x -= select->object_info->text_info->font_size/2;
                        // else if(select->object_info->text_info->allign == "right") select->object_info->rect.x -= select->object_info->text_info->font_size;
